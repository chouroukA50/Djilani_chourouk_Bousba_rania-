...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 13 juin 2022 à 08:31
...
(54, 138, 'salma', '0656892356', 'salma@gmail.com', '', '', '0000-00-00', '00:00:00', 0);
...
--
ALTER TABLE `articles`
  MODIFY `id_art` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=230;
...
--
ALTER TABLE `réservation`
  MODIFY `id_res` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
