...
if(isset($_GET['id'])){
   ...
   if(isset($_POST['send'])){
      ...
      $request = "INSERT INTO `réservation`(name, email, phone, number, message, date, articles_nom,heure, id_don) 
...
<section class="booking">
   ...
   <form action="" method="post" class="book-form">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span> heure :</span>
            <input type="heure" placeholder="entrer l'heure de votre réservation"  name="heure">
         </div>
         <div class="inputBox">
